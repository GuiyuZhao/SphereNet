...
if __name__ == '__main__':
    ...
    shutil.copy2(os.path.join('.', '../../network/SphereNet.py'), '../model.py')
    module_name = ''
    ...
    des_r = 0.8
    # model = module.Descriptor_Net(1.2, 15, 40, 20, 0.04, 30, '3DMatch')
    model = module.SphereNet(1.2, 15, 40, 20, '3DMatch', True, True)
