...
from network.SphereNet import SphereNet
...
class Args(object):
    def __init__(self):
        ...
        shutil.copy2(os.path.join('', '../../network/SphereNet.py'), os.path.join(snapshot_root, 'SphereNet.py'))
        shutil.copy2(os.path.join('', '../../network/SphericalCNN.py'), os.path.join(snapshot_root, 'SphericalCNN.py'))
