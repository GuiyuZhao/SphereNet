...
if __name__ == '__main__':
    ...
    all_trans_matrix = {}
    experiment_id = time.strftime('%m%d%H%M')  # '11210201'#02191824
    #experiment_id = '02200918'
    ...
    for idx in range(len(files)):
        ...
        feat0 = make_open3d_feature(source_desc, 64, source_desc.shape[0])
        feat1 = make_open3d_feature(target_desc, 64, target_desc.shape[0])
